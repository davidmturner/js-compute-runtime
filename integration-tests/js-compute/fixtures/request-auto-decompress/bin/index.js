...
// Request.fastly.decompress option -- automatic decompression of responses
{
    routes.set("/request/constructor/fastly/decompress/true", async () => {
    ...
    routes.set("/request/constructor/fastly/decompress/false", async () => {
        const request = new Request('https://httpbin.org/gzip', {
            headers: {
                accept: 'application/json'
            },
    ...
    routes.set("/fetch/requestinit/fastly/decompress/true", async () => {
    ...
    routes.set("/fetch/requestinit/fastly/decompress/false", async () => {
        const response = await fetch('https://httpbin.org/gzip', {
            headers: {
                accept: 'application/json'
            },
